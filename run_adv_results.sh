...
echo -e "\e[32mRunning: anymal_leatherback_vs_anymal_leatherback adversarial evaluation...\e[0m"
exec python /scripts/reinforcement_learning/harl/paper_results.py \
...
echo -e "\e[32mRunning: trained_anymals_vs_untrained_leatherbacks adversarial evaluation...\e[0m"
exec python /scripts/reinforcement_learning/harl/paper_results.py \
...
echo -e "\e[32mRunning: trained_leatherbacks_vs_untrained_anymals adversarial evaluation...\e[0m"
exec python /scripts/reinforcement_learning/harl/paper_results.py \
  --checkpoint_path  /results/sumo_training_runs/anymals_vs_leatherbacks/models/checkpoints \
