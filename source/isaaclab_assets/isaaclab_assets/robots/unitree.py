...
R1_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=str(Path(isaaclab_asset_path, "unitree_r1.usd")),
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
    ...
    actuators={
        ...
        "feet": ImplicitActuatorCfg(
            ...
            effort_limit_sim=100,
            stiffness={".*_ankle_roll_joint": 20.0, ".*_ankle_pitch_joint": 20.0},
            damping={".*_ankle_roll_joint": 4.0, ".*_ankle_pitch_joint": 4.0},
        ),
        ...
        "arms": ImplicitActuatorCfg(
            joint_names_expr=[".*_shoulder_pitch_joint", ".*_shoulder_roll_joint", ".*_shoulder_yaw_joint", ".*_elbow_joint", ".*_wrist_roll_joint"],
            effort_limit_sim=300,
            stiffness={
