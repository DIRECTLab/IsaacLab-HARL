...
class EventCfg:
    ...
    physics_material_0 = EventTerm(
        ...
        mode="startup",
        params={
            "asset_cfg": SceneEntityCfg("go2_0", body_names=".*"),
    ...
    add_base_mass_0 = EventTerm(
        ...
        mode="startup",
        params={
            "asset_cfg": SceneEntityCfg("go2_0", body_names="base"),
    ...
    physics_material_1 = EventTerm(
        ...
        mode="startup",
        params={
            "asset_cfg": SceneEntityCfg("go2_1", body_names=".*"),
            "static_friction_range": (0.8, 0.8),
            "dynamic_friction_range": (0.6, 0.6),
            "restitution_range": (0.0, 0.2),
            "num_buckets": 64,
    ...
    add_base_mass_1 = EventTerm(
        ...
        mode="startup",
        params={
            "asset_cfg": SceneEntityCfg("go2_1", body_names="base"),
            "mass_distribution_params": (-5.0, 5.0),
            "operation": "add",
        },
    )
...
@configclass
class go2SoccerHeteroByTeamEnvCfg(DirectMARLEnvCfg):
    decimation = 4
    ...
    go2_0: ArticulationCfg = UNITREE_GO2_CFG.replace(prim_path="/World/envs/env_.*/go2_0")
    go2_0.init_state.rot = get_quaternion_tuple_from_xyz(0, 0, torch.pi)
    go2_0.init_state.pos = (0, 0, 0.5)

    go2_1: ArticulationCfg = UNITREE_GO2_CFG.replace(prim_path="/World/envs/env_.*/go2_1")
    go2_1.init_state.rot = get_quaternion_tuple_from_xyz(0, 0, torch.pi)
    go2_1.init_state.pos = (0, 0, 0.5)
    ...
    leatherback_0.init_state.pos = (0, 0, 0.3)
...
class go2SoccerHeteroByTeamEnv(DirectMARLEnv):
    cfg: go2SoccerHeteroByTeamEnvCfg
