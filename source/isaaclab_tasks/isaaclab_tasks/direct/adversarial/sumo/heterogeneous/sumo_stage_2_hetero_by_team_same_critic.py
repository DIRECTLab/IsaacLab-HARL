...
@configclass
class SumoStage2HeteroByTeamSameCriticEnvCfg(DirectMARLEnvCfg):
    decimation = 4
...
class SumoStage2HeteroByTeamSameCriticEnv(DirectMARLEnv):
    cfg: SumoStage2HeteroByTeamSameCriticEnvCfg
