...
# gym.register(
#     id="Isaac-Multi-Agent-Flat-Sumo-Stage1-Multi-Agent-v0",
#     entry_point=SumoStage1MultiAgentEnv,
#     disable_env_checker=True,
#     kwargs={
#         "env_cfg_entry_point": SumoStage1MultiAgentEnvCfg,
#         "rl_games_cfg_entry_point": f"{agents.__name__}:rl_games_flat_ppo_cfg.yaml",
#         "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:AnymalCFlatPPORunnerCfg",
#         "skrl_cfg_entry_point": f"{agents.__name__}:skrl_flat_ppo_cfg.yaml",
#         "harl_happo_cfg_entry_point": f"{agents.__name__}:harl_happo_cfg.yaml",
...
gym.register(
    id="Isaac-Multi-Agent-Flat-Sumo-Stage1-Blocks-Push-v0",
...
gym.register(
    id="Isaac-Multi-Agent-Flat-Sumo-Stage2-v0",
...
gym.register(
    id="Isaac-Multi-Agent-Flat-Sumo-Stage2-Hetero-v0",
