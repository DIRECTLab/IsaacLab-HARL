...
@configclass
class AnymalCMultiAgentAdversarialFlatEnvCfg(DirectMARLEnvCfg):
    # env
...
class AnymalCMultiAgentBarAdversarial(DirectMARLEnv):
    cfg: AnymalCMultiAgentAdversarialFlatEnvCfg

    def __init__(
        self, cfg: AnymalCMultiAgentAdversarialFlatEnvCfg, render_mode: str | None = None, **kwargs
    ):
