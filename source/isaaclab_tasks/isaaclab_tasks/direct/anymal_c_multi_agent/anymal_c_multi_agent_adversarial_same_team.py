...
@configclass
class AnymalCAdversarialSameTeamEnvCfg(DirectMARLEnvCfg):
    # env
...
class AnymalCAdversarialSameTeamEnv(DirectMARLEnv):
    cfg: AnymalCAdversarialSameTeamEnvCfg

    def __init__(self, cfg: AnymalCAdversarialSameTeamEnvCfg, render_mode: str | None = None, debug=False, **kwargs):
        self.debug = debug
    ...
    def _get_rewards(self) -> dict:
        ...
        return {"team_0": (all_rewards["robot_0"] + all_rewards["robot_1"]) / 2}
