...
@configclass
class AnymalCMultiAgentFlatSameTeamBarEnvCfg(DirectMARLEnvCfg):
    # env
...
class AnymalCMultiAgentFlatSameTeamBarEnv(DirectMARLEnv):
    ...
    def _get_dones(self) -> tuple[dict, dict]:
        ...
        return {key: time_out for key in self.cfg.teams.keys()}, {key: dones for key in self.cfg.teams.keys()}
