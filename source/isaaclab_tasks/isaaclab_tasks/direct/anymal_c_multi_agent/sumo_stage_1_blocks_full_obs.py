...
@configclass
class SumoStage1BlocksFullEnvCfg(DirectMARLEnvCfg):
    decimation = 4
...
class SumoStage1BlocksFullEnv(DirectMARLEnv):
    cfg: SumoStage1BlocksFullEnvCfg

    def __init__(
        self, cfg: SumoStage1BlocksFullEnvCfg, render_mode: str | None = None, headless: bool | None = None, **kwargs
    ):
    ...
    def _get_dones(self) -> tuple[dict, dict]:
        ...
        dones = {
            team: torch.logical_or(any_robot_died.clone(), any_robot_reached.clone()) for team in self.cfg.teams.keys()
        }
