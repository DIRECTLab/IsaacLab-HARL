...
class AnymalSoccerHeteroInTeamEnvCfg(DirectMARLEnvCfg):
    ...
    anymal_0.init_state.pos = (-1.0, -2.0, 0.3)
    ...
    anymal_1.init_state.pos = (-1.0, 2.0, 0.3)
    ...
    leatherback_0.init_state.pos = (1.0, -2.0, 0.3)
    ...
    leatherback_1.init_state.pos = (1.0, 2.0, 0.3)
