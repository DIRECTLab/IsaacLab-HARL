...
@configclass
class SumoStage2HeteroByTeamEnvCfg(DirectMARLEnvCfg):
    decimation = 4
...
class SumoStage2HeteroByTeamEnv(DirectMARLEnv):
    cfg: SumoStage2HeteroByTeamEnvCfg

    def __init__(self, cfg: SumoStage2HeteroByTeamEnvCfg, render_mode: str | None = None, headless: bool | None = None, debug: bool | None = False, **kwargs):
