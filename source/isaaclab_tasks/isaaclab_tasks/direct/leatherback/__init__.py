...
from .leatherback_adversarial import (
    LeatherbackAdversarialEnvCfg
)
...
gym.register(
    id="leatherback-adversarial-Direct-v0",
    entry_point="isaaclab_tasks.direct.leatherback.leatherback_adversarial:LeatherbackAdversarialEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": LeatherbackAdversarialEnvCfg,
        "rl_games_cfg_entry_point": f"{agents.__name__}:rl_games_flat_ppo_cfg.yaml",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:AnymalCFlatPPORunnerCfg",
        "skrl_cfg_entry_point": f"{agents.__name__}:skrl_flat_ppo_cfg.yaml",
        "harl_happo_cfg_entry_point": f"{agents.__name__}:harl_happo_cfg.yaml",
