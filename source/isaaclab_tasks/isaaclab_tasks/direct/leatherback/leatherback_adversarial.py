...
@configclass
class LeatherbackAdversarialEnvCfg(DirectMARLEnvCfg):
    decimation = 4
    episode_length_s = 20.0
    action_spaces = {"robot_0": 2, "robot_1": 2}
    observation_spaces = {"robot_0": 8, "robot_1": 8}
    state_space = 0
    possible_agents = [f"robot_{i}" for i in range(2)]
    state_spaces = {agent: 0 for agent in possible_agents}
...
class LeatherbackAdversarialEnv(DirectMARLEnv):
    cfg: LeatherbackAdversarialEnvCfg

    def __init__(self, cfg: LeatherbackAdversarialEnvCfg, render_mode: str | None = None, headless: bool | None = None, **kwargs):
    ...
    def _setup_scene(self):
        ...
        self.leatherback_2 = Articulation(self.cfg.robot_1)
        ...
        self.scene.articulations["leatherback_2"] = self.leatherback_2
    ...
    def _get_observations(self) -> dict:
        ...
        if torch.any(obs_0.isnan()):
            raise ValueError("Observations cannot be NAN")

        return {"robot_0": obs_0}
