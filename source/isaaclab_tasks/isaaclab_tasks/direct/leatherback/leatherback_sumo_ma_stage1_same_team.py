...
@configclass
class LeatherbackSumoMAStage1SameTeamEnvCfg(DirectMARLEnvCfg):
    decimation = 4
...
class LeatherbackSumoMAStage1SameTeamEnv(DirectMARLEnv):
    cfg: LeatherbackSumoMAStage1SameTeamEnvCfg
    ...
    def _get_observations(self) -> dict:
        ...
        return {"team_0": {"robot_0": robot_0_obs, "robot_1": robot_1_obs}}
    ...
    def _get_rewards(self) -> dict:
        ...
        rewards_team0 = {k: torch.nan_to_num(v, nan=0.0, posinf=1e6, neginf=-1e6) for k, v in rewards_team0.items()}
        rewards_team1 = {k: torch.nan_to_num(v, nan=0.0, posinf=1e6, neginf=-1e6) for k, v in rewards_team1.items()}
        ...
        return {
            "team_0": reward_team0 + reward_team1,
        }
